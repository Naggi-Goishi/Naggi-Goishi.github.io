...
const ShoboDot = require('../common.js').ShoboDot;
const paint = require('../common.js').paint;
const deleteDot = require('../common.js').deleteDot;
const getPositionId = require('../common.js').getPositionId;
const getMouseColor = require('../common.js').getMouseColor;
